...
function renderDashboard(){
    ...
    // ============================================================
    // PERBAIKAN LOGIKA PERIODE DASHBOARD (Sesuai Instruksi)
    // ============================================================
    ...
    if (i === 31) {
        l = new Date(k, j, 31); 
        m = new Date(k, j, 30, 23, 59, 59); // Base: Total sampai tgl 30
        ...
        l = new Date(k, j, 16); 
        m = new Date(k, j, 15, 23, 59, 59); // Base: Total sampai tgl 15
...
// ============================================================
// PERBAIKAN LOGIKA PERAIH (Sesuai Instruksi)
// ============================================================
function openAchieverModal() {
    ...
    modal.style.display = 'flex'; body.innerHTML = '<div class="v-empty">Memproses data peraih...</div>'; btnDl.style.display = 'none'; achieverTxtContent = "";
    ...
    if (d >= 16 && d <= 30) {
        ...
        baseCutoff = new Date(y, m - 1, 30, 23, 59, 59); // Dasar target sampai tgl 30 bulan lalu
    ...
    // JIKA TGL 31 s/d 15: MENAMPILKAN HASIL PERIODE 2 (16 s/d 30)
        ...
        baseCutoff = new Date(tY, tM, 15, 23, 59, 59); // Dasar target sampai tgl 15 bulan lalu
    ...
    setTimeout(() => {
        ...
        myTeamData.forEach(mem => {
            ...
            // LOGIKA: Total anggota + Anda (Base) sampai cutoff
