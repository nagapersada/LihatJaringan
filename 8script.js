...
function getPeriodFromDate(date) {
    ...
    if (d >= 16) {
        ...
        // Kita set Start = Tgl 31/30 bulan sebelumnya.
        let pm = m - 1; let py = y;
        if (pm < 0) { pm = 11; py--; }
...
function getPreviousPeriodDates(currentPeriodStartDate) {
    ...
    // prevEnd akan jatuh ke tanggal 15 atau tanggal 30/31 bulan lalu
    // getPeriodFromDate akan menangani logika penentuan range-nya
...
function renderDashboard(){
    ...
    // Gunakan End Date untuk menentukan nama bulan agar akurat (Misal P1 Jan berakhir 15 Jan)
...
// ============================================================
// LOGIKA TIM PER LEVEL (DIPERBAIKI: ADA TANGGAL)
// ============================================================
...
// ============================================================
// TOMBOL PERAIH (ACHIEVER) - DIPERBAIKI (PERIODE LABEL)
// ============================================================
...
window.openAchieverModal = function() {
    ...
    // Perbaikan: Ambil periode sebelumnya, lalu ambil Nama Bulan dari END Date periode tsb
    // Agar jika Periode 1 Januari (yg start 31 Des), tetap tertulis JANUARI.
    const prevP = getPreviousPeriodDates(currP.start); 
